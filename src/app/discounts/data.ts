...

  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "text",
        content:
          "После оформления заказа с Вами свяжется менеджер для уточнения деталей заказа и рассчитает конечную стоимость с учётом скидки на доставку.",
      },
    ],
  },

  {
    ...
    blocks: [
      ...
      },
      {
        id: "birthday-3",
        type: "text",
        content: "Дарим 10% скидку на любую покупку в честь твоего дня рождения.",
      },
      // 3. Срок действия
      {
        id: "birthday-4",
      ...
      },
      {
        id: "birthday-5",
        type: "text",
        content: "Скидка доступна в течение трёх дней до и трёх дней после твоей даты рождения.",
      },
      ...
      },
      {
        ...
        type: "list",
        items: [
          "Добавь товары в корзину на сайте.",
          "Введи кодовое слово DRCD при оформлении заказа.",
          "Подтверди дату рождения - отправь нашему менеджеру фото или скан документа (паспорт, водительские права и т.п.).",
          "После проверки скидка будет активирована, и ты сможешь завершить заказ по сниженной цене.",
        ],
