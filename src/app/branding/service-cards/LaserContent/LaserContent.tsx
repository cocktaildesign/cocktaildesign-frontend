    ...
    <div className={styles.lazerContent}>
      <header className={styles.lazerContentHeader}>
        ...
        <div className={styles.lazerContentHeaderText}>
          ...
          <p className={styles.lazerContentHeaderParagraph}>
            Лазерная гравировка - это процесс, при котором лазер наносит рисунок, логотип или надпись на металл.
            Изображение мы наносим черным или белым цветом, оно не стирается и сохраняет свой вид длительное время.
          </p>
        </div>
      </header>
